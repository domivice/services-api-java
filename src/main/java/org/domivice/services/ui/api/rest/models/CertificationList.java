...
@Schema(name = "CertificationList", description = "")
...
public class CertificationList {
    ...
    @Valid
    private List<@Valid Certification> data = new ArrayList<>();
     ...
     * Default constructor
     *
     * @deprecated Use {@link CertificationList#CertificationList(List<@Valid Certification>, String, BigDecimal, String, BigDecimal)}
     */
    @Deprecated
     ...
     */
    public CertificationList(List<@Valid Certification> data, String nextPage, BigDecimal pageCount, String previousPage, BigDecimal totalItemsCount) {
        this.data = data;
    ...
    public CertificationList data(List<@Valid Certification> data) {
        this.data = data;
        return this;
    }

    public CertificationList addDataItem(Certification dataItem) {
        if (this.data == null) {
    ...
    @JsonProperty("data")
    public List<@Valid Certification> getData() {
        return data;
    }

    public void setData(List<@Valid Certification> data) {
        this.data = data;
    }

    public CertificationList nextPage(String nextPage) {
        this.nextPage = nextPage;
        return this;
    }
    ...
    public CertificationList pageCount(BigDecimal pageCount) {
        this.pageCount = pageCount;
        return this;
    }
    ...
    public CertificationList previousPage(String previousPage) {
        this.previousPage = previousPage;
        return this;
    }
    ...
    public CertificationList totalItemsCount(BigDecimal totalItemsCount) {
        this.totalItemsCount = totalItemsCount;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        CertificationList certificationList = (CertificationList) o;
        return Objects.equals(this.data, certificationList.data) &&
                Objects.equals(this.nextPage, certificationList.nextPage) &&
                Objects.equals(this.pageCount, certificationList.pageCount) &&
                Objects.equals(this.previousPage, certificationList.previousPage) &&
                Objects.equals(this.totalItemsCount, certificationList.totalItemsCount);
    }
    ...
    public String toString() {
        ...
        sb.append("class CertificationList {\n");
