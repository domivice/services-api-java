...
import org.domivice.services.web.api.rest.models.ServiceSummary;
...
@Schema(name = "ServiceList", description = "")
...
public class ServiceList {
  ...
  @Valid
  private List<@Valid ServiceSummary> data = new ArrayList<>();
  ...
  /**
   * Default constructor
   * @deprecated Use {@link ServiceList#ServiceList(List<@Valid ServiceSummary>, String, BigDecimal, String, BigDecimal)}
   */
  @Deprecated
  public ServiceList() {
    super();
   ...
   */
  public ServiceList(List<@Valid ServiceSummary> data, String nextPage, BigDecimal pageCount, String previousPage, BigDecimal totalItemsCount) {
    this.data = data;
  ...
  public ServiceList data(List<@Valid ServiceSummary> data) {
    this.data = data;
    return this;
  }

  public ServiceList addDataItem(ServiceSummary dataItem) {
    if (this.data == null) {
  ...
  */
  ...
  @JsonProperty("data")
  public List<@Valid ServiceSummary> getData() {
    return data;
  }

  public void setData(List<@Valid ServiceSummary> data) {
    this.data = data;
  }

  public ServiceList nextPage(String nextPage) {
    this.nextPage = nextPage;
    return this;
  }
  ...
  */
  ...
  public ServiceList pageCount(BigDecimal pageCount) {
    this.pageCount = pageCount;
    return this;
  }
  ...
  */
  ...
  public ServiceList previousPage(String previousPage) {
    this.previousPage = previousPage;
    return this;
  }
  ...
  */
  ...
  public ServiceList totalItemsCount(BigDecimal totalItemsCount) {
    this.totalItemsCount = totalItemsCount;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.data, serviceList.data) &&
        Objects.equals(this.nextPage, serviceList.nextPage) &&
        Objects.equals(this.pageCount, serviceList.pageCount) &&
        Objects.equals(this.previousPage, serviceList.previousPage) &&
        Objects.equals(this.totalItemsCount, serviceList.totalItemsCount);
  }
