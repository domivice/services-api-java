...
@Schema(name = "DocumentTypeList", description = "")
...
public class DocumentTypeList {
    ...
    @Valid
    private List<@Valid DocumentType> data = new ArrayList<>();
     ...
     * Default constructor
     *
     * @deprecated Use {@link DocumentTypeList#DocumentTypeList(List<@Valid DocumentType>, String, BigDecimal, String, BigDecimal)}
     */
    @Deprecated
     ...
     */
    public DocumentTypeList(List<@Valid DocumentType> data, String nextPage, BigDecimal pageCount, String previousPage, BigDecimal totalItemsCount) {
        this.data = data;
    ...
    public DocumentTypeList data(List<@Valid DocumentType> data) {
        this.data = data;
        return this;
    }

    public DocumentTypeList addDataItem(DocumentType dataItem) {
        if (this.data == null) {
    ...
    @JsonProperty("data")
    public List<@Valid DocumentType> getData() {
        return data;
    }

    public void setData(List<@Valid DocumentType> data) {
        this.data = data;
    }

    public DocumentTypeList nextPage(String nextPage) {
        this.nextPage = nextPage;
        return this;
    }
    ...
    public DocumentTypeList pageCount(BigDecimal pageCount) {
        this.pageCount = pageCount;
        return this;
    }
    ...
    public DocumentTypeList previousPage(String previousPage) {
        this.previousPage = previousPage;
        return this;
    }
    ...
    public DocumentTypeList totalItemsCount(BigDecimal totalItemsCount) {
        this.totalItemsCount = totalItemsCount;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        DocumentTypeList documentTypeList = (DocumentTypeList) o;
        return Objects.equals(this.data, documentTypeList.data) &&
                Objects.equals(this.nextPage, documentTypeList.nextPage) &&
                Objects.equals(this.pageCount, documentTypeList.pageCount) &&
                Objects.equals(this.previousPage, documentTypeList.previousPage) &&
                Objects.equals(this.totalItemsCount, documentTypeList.totalItemsCount);
    }
    ...
    public String toString() {
        ...
        sb.append("class DocumentTypeList {\n");
