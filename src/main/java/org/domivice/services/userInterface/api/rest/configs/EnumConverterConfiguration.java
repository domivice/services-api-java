package org.domivice.services.userInterface.api.rest.configs;
...
public class EnumConverterConfiguration {
    ...
    @Bean(name = "org.domivice.services.userInterface.api.rest.configs.EnumConverterConfiguration.bookingTypeConverter")
    ...
    @Bean(name = "org.domivice.services.userInterface.api.rest.configs.EnumConverterConfiguration.certificationStatusConverter")
    ...
    @Bean(name = "org.domivice.services.userInterface.api.rest.configs.EnumConverterConfiguration.documentRequirementStatusConverter")
    ...
    @Bean(name = "org.domivice.services.userInterface.api.rest.configs.EnumConverterConfiguration.documentStatusConverter")
    ...
    @Bean(name = "org.domivice.services.userInterface.api.rest.configs.EnumConverterConfiguration.licenceRequirementStatusConverter")
    ...
    @Bean(name = "org.domivice.services.userInterface.api.rest.configs.EnumConverterConfiguration.licenceStatusConverter")
    ...
    @Bean(name = "org.domivice.services.userInterface.api.rest.configs.EnumConverterConfiguration.serviceOfferingTypeConverter")
    ...
    @Bean(name = "org.domivice.services.userInterface.api.rest.configs.EnumConverterConfiguration.serviceProviderResponseRateConverter")
    ...
    @Bean(name = "org.domivice.services.userInterface.api.rest.configs.EnumConverterConfiguration.serviceProviderStatusConverter")
    ...
    @Bean(name = "org.domivice.services.userInterface.api.rest.configs.EnumConverterConfiguration.serviceStatusConverter")
